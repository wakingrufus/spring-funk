...
@SpringBootTest(
    classes = [JacksonDslApplication::class],
    webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
)
@ContextConfiguration(initializers = [JacksonDslApplication::class])
...
internal class JacksonDslApplication : SpringDslApplication {
